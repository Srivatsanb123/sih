    ...
    <>
      <div className="2xl:container mx-auto">
        <div className="w-[90%] mx-auto">
          <div className="md:flex mt-40 md:space-x-10 items-start px-14 ">
            ...
            >
              <h1 className="text-2xl font-semibold text-darken lg:pr-40">
                A <span className="text-yellow-500">user interface</span> built for Collaboration
              </h1>
              <div className="flex items-center space-x-5 my-5">
                ...
                <p>
                Researchers can find funding opportunities and connect with incubators
                </p>
              </div>
              <div className="flex items-center space-x-5 my-5">
                <div className="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
                ...
                <p>Entrepreneurs can network with investors for idea validation and growth.</p>
              </div>
              <div className="flex items-center space-x-5 my-5">
                <div className="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
                  <svg
                ...
                <p>Policy makers can access real-time data and insights to shape future policies.</p>
              </div>
            </div>
          </div>
        </div>
