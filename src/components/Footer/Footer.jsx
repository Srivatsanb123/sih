const Footer = () => {
  return (
    <div className=" 2xl:container mx-auto bg-yellow-500">
        ...
        <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="sm:col-span-2">
              ...
              >
                <img src="img/srijansetu_icon.png" alt=""  className=" h-14"/>
                <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase mt-5">
                  SRIJANSETU
                </span>
              </a>
